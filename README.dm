...
> Conhecer um dos processos de desenvolvimento para a criação de um site!
...
- [Guia de Formatação README.dm](https://docs.github.com/pt/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax)
